              ...
              <div class="card text-dark rounded-4"  >
                <div class="card-body p-3 text-center" dir="rtl">
                  ...
                  <div class="mb-md-5 mt-md-4 pb-3">
                    ...
                    <h2 class="fw-bold mb-2 text-uppercase"> اعادة تعيين كلمة السر  </h2>
                    <p class=" mb-5">من فضلك ادخل  الحقول المطلوبة!</p>
      
                    <div class="form-outline form-white mb-4 text-end">
                      <label class="form-label" for="typeEmailX"> الإيميل</label>
                      <input type="email" id="username" name="email" class="form-control form-control-lg  border border-secondary" required />
                    ...
                    <button class="cta-btn" type="submit" name="send"> ارسال</button>
                  </div>
      
                  <div>

                  <p class="mb-0">  <a href="login.php"  class=" fw-bold">العودة الى تسجيل الدخول</a>   
                   </p>
                  </div>
