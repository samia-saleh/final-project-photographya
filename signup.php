...
if(!isset($email_existance) and !isset($username_existance))
{
  ...
  $conn->query("insert into users (username,email,password,role,bio,address,avatar,	facebook,instagram,whatsapp,is_locked)
   values('$username','$email','$password','مصور','$bio','$address','65a6217141f00.jpg','$facebook','$instagram','$whatsapp',0)");
   $photographer= $conn->query("select id  from users where username='$username'");
            ...
            <div class="card-body p-3 ">
              ...
              <div class="mb-md-5 mt-md-4 pb-3 text-center" dir="rtl">
                ...
                <div class="form-outline form-white mb-4 text-end">
                  ...
                  <div class="form-outline form-white mb-4 text-end">
                    <label class="form-label me-2" for="bio"> بايو</label>
                    <textarea  id="bio" value="<?=isset($bio) ? $bio : "" ?>" class="form-control form-control-lg border border-secondary" name="bio" required >
                    </textarea>
                ...
                <div class="form-group form-outline form-white mb-4 text-end">
                  ...
                  <select name="scope[]" multiple class="form-control" value="<?=isset($scope) ? $scope : "" ?>" >
                    <?php
                ...
                <div class="form-group form-outline form-white mb-4 text-end" >
                  ...
                  <select name="fields[]" multiple class="form-control" value="<?=isset($scope) ? $scope : "" ?>">
                    <?php
                ...
                <div class="form-outline form-white mb-4 text-end">
                  <label class="form-label me-2" for="typeEmailX">رابط حساب الفيس:</label>
                  <input  type="url" pattern="^(https?:\/\/)?(www\.)?facebook\.com\/[a-zA-Z0-9\.]+$" value="<?=isset($facebook) ? $facebook : "" ?> " name =" facebook"id="facebook" class="form-control form-control-lg  border border-secondary" required />


                </div>
                <div class="form-outline form-white mb-4 text-end">
                  <label class="form-label me-2" for="typeEmailX"> رابط حساب الانستقرام :</label>
                  <input type="url" pattern="^(https?:\/\/)?(www\.)?instagram\.com\/[a-zA-Z0-9_\.]+$" value="<?=isset($instagram) ? $instagram : "" ?>" 
                  name =" instagram"id="instagram" class="form-control form-control-lg  border border-secondary" required />


                </div>
                <div class="form-outline form-white mb-4 text-end">
                  <label class="form-label me-2" for="typeEmailX">  رابط حساب الواتس اب:</label>
                  <input type="url" pattern="^https:\/\/wa\.me\/qr\/[A-Za-z0-9]+$" required value="<?=isset($whatsapp) ? $whatsapp : "" ?>" name =" whatsapp"id="whatsapp" class="form-control form-control-lg  border border-secondary" required />
